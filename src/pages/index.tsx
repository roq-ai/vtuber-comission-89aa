...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`VTuber Comission website`}</title>

        <meta
          name="description"
          content="Experience VTuber Commission Website - Your Ultimate Destination for Spanish Speaking VTubers Services, Offering Custom Country-Based Solutions with Secure Stripe and Paypal Payment Options."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`VTuber Comission website`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience VTuber Commission Website - Your Ultimate Destination for Spanish Speaking VTubers Services, Offering Custom Country-Based Solutions with Secure Stripe and Paypal Payment Options.`}
            </Text>
            <Box
