...
import { getContentCreators, deleteContentCreatorById, createContentCreator } from 'apiSdk/content-creators';
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createContentCreator}
                deleteHandler={deleteContentCreatorById}
                fetcher={getContentCreators}
